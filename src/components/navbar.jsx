...
export default function Navbar() {
  const navigation1 = [{ name: "Home", href: "/", current: true }];
  ...
  return (
    <div className="bg-transparent top-0 z-999">
      <Disclosure as="nav" className="">
        {({ open }) => (
          <div className="">
            <div className="mx-auto w-[92%] px-2 sm:px-6 lg:px-4 bg-transparent">
                      ...
                      {navigation1.map((item) => (
                        <Link
                          ...
                          className={classNames(
                            item.current
                              ? "text-white transition-colors duration-300 transform hover:text-blue-500"
                              : "text-white transition-colors duration-300 transform hover:text-blue-500",

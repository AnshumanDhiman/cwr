...
export default function Newsletter() {
  return (
    <>
        <section className="px-28 shadow-xl border-2 bg-gradient-to-r from-blue-500 to-blue-800">
    <div className="container px-4 py-16 mx-auto lg:flex lg:items-center lg:justify-between">
        ...
        <div className="mt-8 lg:mt-0">
            <div className="flex flex-col space-y-3 sm:space-y-0 sm:flex-row sm:-mx-2">
                <input id="email" type="text" className="px-4 py-2 text-white bg-white border border-gray-200 rounded-lg sm:mx-2    focus:border-blue-400  focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Email Address" />
            ...
            <p className="mt-3 text-sm text-white">Sign up with your email address to receive news & updates.</p>
        </div>
    </div>
</section>
    </>

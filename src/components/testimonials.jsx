        ...
        <section className="bg-white px-40">
          <div className="container px-6 py-10 mx-auto">
            ...
            <section className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 lg:grid-cols-2 xl:grid-cols-3">
              <div className="p-8 border rounded-lg  -mx-2 border-green-600">
                <div className="flex items-center ">
                  ...
                  <div className="mx-2">
                    <h1 className="font-semibold text-gray-800 ">Elon Musk</h1>
                    <span className="text-sm text-gray-500">Founder, SpaceX</span>
                  </div>
                </div>
                <p className="leading-loose text-gray-500 mt-8">

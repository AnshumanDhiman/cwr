...
export default function Software() {
  return (
    <>
      ...
      <div
        className="p-8 rounded-2xl shadow-xl bg-white cursor-pointer transition ease-in-out border-t-[16px] border-rose-700 "
      >
        ...
        <button className='text-sm px-4 py-2 font-sm text-white capitalize transition-colors duration-300 transform bg-rose-700 rounded-lg hover:bg-rose-600 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80'>Explore More</button>
      </div>
      <div
        className="p-8 rounded-2xl shadow-xl bg-white cursor-pointer transition ease-in-out border-t-[16px] border-rose-700 "
      >

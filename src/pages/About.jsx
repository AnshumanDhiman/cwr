...
const About = () => {
  return (
    <>
    <div className="relative grid w-full bg-gradient-to-r from-yellow-600 to-yellow-800 h-[20rem] items-center">
    ...
    <div class="container flex flex-col px-20 py-10 mx-auto space-y-6 lg:h-[32rem] lg:py-16 lg:flex-row lg:items-center">
        <div class="w-full lg:w-1/2">
            <div class="lg:max-w-lg">
                <h1 class="text-3xl font-semibold tracking-wide text-gray-800  lg:text-4xl">Find your premium new glasses exported from US</h1>
                <p class="mt-4 text-gray-600 ">We work with the best remunated glasses dealers in US to find your new glasses.</p>
    ...
    <div class="py-10 mx-auto">
        ...
        <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-4 px-24">
            <div class="flex flex-col items-center p-8 transition-colors duration-300 transform cursor-pointer group hover:bg-blue-600 rounded-xl">
                ...
                <h1 class="mt-4 text-2xl font-semibold text-gray-700 capitalize  group-hover:text-white">arthur melo</h1>
            ...
            <div class="flex flex-col items-center p-8 transition-colors duration-300 transform cursor-pointer group hover:bg-blue-600 rounded-xl">
                ...
                <h1 class="mt-4 text-2xl font-semibold text-gray-700 capitalize  group-hover:text-white">Amelia. Anderson</h1>
            ...
            <div class="flex flex-col items-center p-8 transition-colors duration-300 transform cursor-pointer group hover:bg-blue-600 rounded-xl">
                ...
                <h1 class="mt-4 text-2xl font-semibold text-gray-700 capitalize  group-hover:text-white">Olivia Wathan</h1>
            ...
            <div class="flex flex-col items-center p-8 transition-colors duration-300 transform cursor-pointer group hover:bg-blue-600 rounded-xl">
                ...
                <h1 class="mt-4 text-2xl font-semibold text-gray-700 capitalize  group-hover:text-white">John Doe</h1>
            ...
            <div class="flex flex-col items-center p-8 transition-colors duration-300 transform cursor-pointer group hover:bg-blue-600 rounded-xl">
                ...
                <h1 class="mt-4 text-2xl font-semibold text-gray-700 capitalize  group-hover:text-white">Mia</h1>

                <p class="mt-2 text-gray-500 capitalize  group-hover:text-gray-300">Graphic Designer</p>
            ...
            <div class="flex flex-col items-center p-8 transition-colors duration-300 transform cursor-pointer group hover:bg-blue-600 rounded-xl">
                ...
                <h1 class="mt-4 text-2xl font-semibold text-gray-700 capitalize  group-hover:text-white">Junior REIS</h1>

                <p class="mt-2 text-gray-500 capitalize  group-hover:text-gray-300">Products Managers</p>
            ...
            <div class="flex flex-col items-center p-8 transition-colors duration-300 transform cursor-pointer group hover:bg-blue-600 rounded-xl">
                ...
                <h1 class="mt-4 text-2xl font-semibold text-gray-700 capitalize  group-hover:text-white">Joseph Gonzalez</h1>

                <p class="mt-2 text-gray-500 capitalize  group-hover:text-gray-300">Software engineer</p>
            ...
            <div class="flex flex-col items-center p-8 transition-colors duration-300 transform cursor-pointer group hover:bg-blue-600 rounded-xl">
                ...
                <h1 class="mt-4 text-2xl font-semibold text-gray-700 capitalize  group-hover:text-white">Emma Doe</h1>

                <p class="mt-2 text-gray-500 capitalize  group-hover:text-gray-300">Content Writer</p>
